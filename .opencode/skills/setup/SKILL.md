...
If the user chooses **OneCLI gateway** and the chosen runtime is not Docker, tell them OneCLI is optional and unsupported for Apple Container here, then continue with direct auth.
