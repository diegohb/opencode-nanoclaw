...
**Never ask again**:
1. Replace contents of `.opencode/skills/setup/diagnostics.md` with `# Diagnostics — opted out`
2. Replace contents of `.opencode/skills/update-nanoclaw/diagnostics.md` with `# Diagnostics — opted out`
3. Remove the `## 9. Diagnostics` section from `.opencode/skills/setup/SKILL.md` and the `## Diagnostics` section from `.opencode/skills/update-nanoclaw/SKILL.md`
