...
- **Skills** (`.opencode/skills/`): unlikely to conflict unless you edited an upstream skill
...
- **Skills** (`.opencode/skills/`): unlikely to conflict unless the user edited an upstream skill
...
1. Use the Read tool to read `.opencode/skills/update-nanoclaw/diagnostics.md`.
