...
> 4. `ls .opencode/skills/` — installed skills
...
Custom skills (user-created, not from upstream): `.opencode/skills/my-custom-skill/` — copy as-is from main tree.
...
For behavior customizations (AGENTS.md files): copy from the main tree. These are user content, not code.
...
1. Use the Read tool to read `.opencode/skills/migrate-nanoclaw/diagnostics.md`.
